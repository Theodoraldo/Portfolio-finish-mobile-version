...
const showButton = document.querySelector('.popBtn');
const modelExit = document.querySelector('#model-close');
...
const cardData = [
  {
    ...
    content: 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text   ever since the 1500. Lorem Ipsum is simply dummy text of the printing and typesetting industry.</br> Lorem Ipsum has been the industrys standard dummy text ever since the 1500s, when an unknown printer took a galley.Lorem Ipsum han printer took a galley of type and scrambled it 1960s with the releawn printer took a galley of type and scrambled it 1960s.',
  ...
  showButton.addEventListener('click', () => {
    ...
    <div class="model-body">
      <div class="model-title">
        ...
        <div id="model-close"><i class="uil uil-multiply"></i></div>
        <ul class="card-sub">
...
modelExit.addEventListener('click', () => {
  console.log('hello');
});
